...
The other type is a Differential Power Analysis where many different checks are used and then a difference is applied to only show the 'significant' changes. Due to the nature of the DES you can isolate it to the 8 S boxes which move 6 input bits to 4 output bits. 

\color{red}{TALK ABOUT DPA AGAINST HMAC-MD5}

\begin{figure}
    graphic from DPA report
    \label{fig:desRound}
\end{figure}
