...
The same group, 6 years later presented the first public MD5 collision using a single block \cite{Xie2013}.
\begin{figure}
\begin{tabular}{|r|  l l l l|}
...
It isn't guaranteed that this search will be successful as multiple hashes are likely to reduce to the same $p$, this is illustrated in figure \ref{fig:col}.
\begin{figure}
    \begin{center}
    \begin{tikzpicture}[>=latex']
